...
class OrisonProject {
    ...
    async build() {
        ...
        const outputs = await this.renderBuildOutputs(site);
    ...
    async evaluateHtmlTemplate(sourcePath, context) {
        ...
        return templateFactory(context, requireFromPackage('lit').html);
    }
...
//# sourceMappingURL=orison-static-server-VE6nYhpj.js.map
